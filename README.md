...
From 2021-03-08 you can download `*.fit` file from your _Garmin Connect_ account, for how to do it read **Usage** section below.
...
![Alt text](https://github.com/karaul/fitplotter/blob/main/screenshots/home-screenshot.png?raw=true)
